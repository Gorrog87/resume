  ...
  return (
    <>
      <div className="text-center mb-20">
        <h4 className="my-20 underline underline-offset-8 a-propos">
        ...
        <div className="bio">
          <q>
            <i>
              ...
              <br></br>Je m'appelle Maxime, j'ai 35 ans, et après plusieurs
              années passées dans le commerce (retail), je me suis réorienté
              vers la programmation informatique.<br></br>
              <br></br>
              ...
              <strong>
                <a
                  href="https://fr.wikipedia.org/wiki/Développeur_web"
                  target="_blank"
                  rel="noreferrer"
                >
                  développeur web
                ...
                <a
                  href="https://fr.wikipedia.org/wiki/Développeur_full_stack"
                  target="_blank"
                  rel="noreferrer"
                >
                  fullstack
                ...
                et son framework{" "}
                <a
                  href="https://fr.wikipedia.org/wiki/Ruby_on_Rails"
                  target="_blank"
                  rel="noreferrer"
                >
                  Ruby on Rails
              ...
              ), lequel a duré neuf semaines. Après avoir obtenu la
              certification (
              <strong>
                Titre RNCP de{" "}
                <a
              ...
              formation en alternance (Titre Professionnel
              Concepteur-Développeur d’Applications Niveau 6 (équivalent
              Bac+3/4)), de l’école{" "}
              <strong>
                <a
              ...
              principalement, mais également en région{" "}
              <strong>parisienne</strong>.<br></br> Si vous êtes à la recherche
              d’un <strong>alternant</strong> très motivé, impliqué et avec une
              grande soif d’apprendre, n'hésitez pas à me <space></space>
              <strong>
